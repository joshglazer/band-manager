...
export default function SpotifyEmbedPlayer({
  ...
  // Show a plain link when not authenticated, when loading, or when the track ID
  // can't be parsed — the banner handles prompting users to connect.
  if (status === 'loading' || status === 'unauthenticated' || !trackId) {
    return (
